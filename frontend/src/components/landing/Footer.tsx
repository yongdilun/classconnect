        ...
        <div className="footer-grid">
          ...
          <div className="footer-links">
            ...
            <ul className="footer-menu">
              <li><Link to="/teacher/signup" className="footer-link">Sign Up</Link></li>
              <li><Link to="/teacher/login" className="footer-link">Login</Link></li>
          ...
          <div className="footer-links">
            ...
            <ul className="footer-menu">
              <li><Link to="/student/signup" className="footer-link">Sign Up</Link></li>
